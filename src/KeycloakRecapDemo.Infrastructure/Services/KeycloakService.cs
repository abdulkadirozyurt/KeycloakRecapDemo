...
using KeycloakRecapDemo.Domain.Dtos.Auth;
    ...
    IOptions<KeycloakConfiguration> options) : IJwtProvider
{
    public async Task<string> GetAccessToken(CancellationToken cancellationToken = default)
    {
        ...
        string endpoint = options.Value.TokenEndpoint;
        ...
        KeyValuePair<string, string> clientSecret = new("client_secret", options.Value.Credentials.Secret);
    ...
    public async Task<string> CreateJwtAsync(string usernamerequest, string password, CancellationToken cancellationToken)
    {
        // string endpoint = $"{options.Value.HostName}/realms/{options.Value.Realm}/protocol/openid-connect/token";
        string endpoint = options.Value.TokenEndpoint;
        ...
        KeyValuePair<string, string> clientId = new("client_id", options.Value.ClientId);
        KeyValuePair<string, string> clientSecret = new("client_secret", options.Value.Credentials.Secret);
        KeyValuePair<string, string> username = new("username", usernamerequest);
